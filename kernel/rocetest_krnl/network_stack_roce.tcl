...
set_property -dict [list CONFIG.C_NUM_OF_PROBES {15} CONFIG.C_PROBE2_WIDTH {512} \
CONFIG.C_PROBE5_WIDTH {512} CONFIG.C_PROBE8_WIDTH {160} CONFIG.C_PROBE9_WIDTH {32} \
CONFIG.C_PROBE10_WIDTH {8} CONFIG.C_EN_STRG_QUAL {1} CONFIG.C_ADV_TRIGGER {true} \
...
set_property -dict [list CONFIG.C_NUM_OF_PROBES {20} CONFIG.C_PROBE2_WIDTH {512} \
CONFIG.C_PROBE5_WIDTH {512} CONFIG.C_PROBE8_WIDTH {512} CONFIG.C_PROBE9_WIDTH {32} \
CONFIG.C_PROBE10_WIDTH {8} CONFIG.C_PROBE13_WIDTH {512} CONFIG.C_PROBE16_WIDTH {512} \
CONFIG.C_PROBE19_WIDTH {512} CONFIG.C_EN_STRG_QUAL {1} CONFIG.C_ADV_TRIGGER {true} \
